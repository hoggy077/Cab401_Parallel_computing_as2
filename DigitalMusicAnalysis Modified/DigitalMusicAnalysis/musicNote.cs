...
namespace DigitalMusicAnalysis
{
    public class musicNote
    {
        ...
        public musicNote(double freq, double dur)
        {
            ...
            //-- replaced cases with duplicate results with fall-trough cases
        ...
        public musicNote(Vector3 noteData) : this(noteData.Y, noteData.Z) { }
        public musicNote(Vector4 noteData) : this(noteData.Y, noteData.Z) { }
    }
}
